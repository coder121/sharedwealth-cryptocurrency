 ...
 */
public class TransactionsDemo3  {
	...
	TransactionsDemo3(String server, int port,User2 u) {
		this.server = server;
		this.port = port;
		this.user=u;
...
//		Transaction t=new Transaction("bc", 2);
		User2 bob=new User2("user3.wallet");
		bob.createTransaction("1hXqHPZTHytx4WVmVCjf211hng3yXf9V6", bob.getAddress(), 4.2);
		...
		TransactionsDemo3 client = new TransactionsDemo3(serverAddress, portNumber, bob);
